...
public class CatalogueServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Catalogue.listOfWorks.isEmpty()) {
            ...
            //gud=1ernica Ajouter les oeuvres au catalogue
guernica.setId(1);
 tournesols.setId(2);
 promenade.setId(3);
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Liste de nos oeuvres</title>");            
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Voici la liste de nos oeuvres : </h1>");
        
for(Work work : Catalogue.listOfWorks) {
            out.println("<a href='workinfo?id=" + work.getId() + "'> " + work.getTitle() + ""
                    + "(" + work.getYear() + ")"  + " </a> <br/>");
        }        
        out.println("</body>");
        out.println("</html>");
